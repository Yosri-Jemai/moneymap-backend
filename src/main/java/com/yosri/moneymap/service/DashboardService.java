...
import com.yosri.moneymap.dto.RecentTransactionDTO;
...
public class DashboardService {
    ...
    public Map<String, Object> getDashboardData() {
        ...
        List<RecentTransactionDTO> recentTransactios =  concat(latestIncomes.stream().map( income -> RecentTransactionDTO.builder()
                .id(income.getId())
        ...
        returnValue.put("recentTransactios", recentTransactios);
        return returnValue;
    }
}
